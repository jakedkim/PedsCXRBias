...
class CXRDataset(Dataset):
  def __init__(self,
    ...
    elif transform == 'mytransform':
      transform = transforms.Compose([
      transforms.RandomResizedCrop(224, scale=(0.8, 1.0)),  # Random central crop
      transforms.RandomHorizontalFlip(),  # Random horizontal flips
      transforms.RandomRotation(10),  # Randomly rotate the image by ±10 degrees
      transforms.ToTensor()  # Convert to tensor (needed for input to a PyTorch model)
      ])
